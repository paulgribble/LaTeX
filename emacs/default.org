...
#+LATEX_HEADER: \setmainfont[Ligatures=TeX,UprightFont={* Light}]{Helvetica Neue}
#+LATEX_HEADER: \setsansfont[BoldFont={* Bold}]{Helvetica Neue}
...
#+LATEX_HEADER: \titleformat*{\subsection}{\sffamily\normalsize\bfseries}
